...
- PAPER current-history lookup vybírá autoritativní revizi a posledních `lookback` seancí **v SQL per instrument**; dlouho žijící worker už nematerializuje všechny historické revize před Python filtrem.
