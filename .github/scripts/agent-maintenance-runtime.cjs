...
// Reviewed Protect main baseline: 8 CI contexts, independent of the 9 CI job list.
const REQUIRED_CHECKS = ["api", "container-build", "frontend", "integration-postgres", "production-smoke", "quality", "security", "unit-research"].map(context => ({context, integration_id: 15368}));
