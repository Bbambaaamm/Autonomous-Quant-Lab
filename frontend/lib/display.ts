...
export const states: Record<string, string> = {
    ...
    SYNC_MARKET_IDENTITIES: "Aktualizace identit trhu", SYNC_MARKET_PRICE_TASK: "Sběr cen trhu", MARKET_DATA_TASK_PROCESSED: "Zpracován cenový úkol", MARKET_IDENTITIES_RECEIVED: "Identity přijaty", NO_PENDING_MARKET_DATA: "Žádný splatný cenový úkol", MARKET_IDENTITIES_STALE: "Zastaralý adresář identit", MARKET_BATCH_CREATED: "Připravena nová cenová dávka",
    SYNC_MARKET_CATALOG: "Aktualizace katalogu trhu", CATALOG_RECEIVED: "Katalog přijat", CONTROL_CATALOG_SCHEDULED: "Naplánována aktualizace katalogu",
